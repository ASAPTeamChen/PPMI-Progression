...
```{r}
file_path <- "/Users/jackson/Desktop/LRRK2 MS Materials/LRRK2 PPMI (2023 V4) Analysis Data (Latest) (SAA Negative).xlsx"
...
data_dem <- data_dem1 %>%
  mutate(
    Cohort = factor(Cohort, levels = c("SPD", "LRRK2 PD", "GBA PD")),
...
data_moca2 <- data_moca1 %>%
  ...
  mutate(
    `Group ID` = factor(`Group ID`, levels = c("SPD", "LRRK2 PD", "GBA PD")))
