...
data_dem <- data_dem1 %>%
  mutate(
    Cohort = factor(Cohort, levels = c("SPD", "G2019S PD", "M1646T R1441C/G PD", "N2081D/N14D")),
...
plot_updrs_model2 <- sjPlot::plot_model(updrs_model2, type = "pred", ci.lvl = NA, terms = c("visit_year", "Group ID"), colors = "breakfast club") +
  ...
  scale_y_continuous(limits = c(20, 60)) + # Set y-axis range 
