...
```{r}
file_path <- "/Users/jackson/Desktop/LRRK2 MS Materials/LRRK2 PPMI (2023 V4) Analysis Data (Latest) (SAA Positive (SNPs).xlsx"
...
histogram_visit_year <- ggplot(data_moca, aes(x = visit_year)) +
  ...
  scale_y_continuous(limits = c(0,800)) +  # Set y-axis range
...
plot_moca_model2 <- sjPlot::plot_model(moca_model2, type = "pred", ci.lvl = NA, terms = c("visit_year", "Group ID"), colors = "breakfast club") +
  ...
  scale_y_continuous(limits = c(20, 30)) + # Set y-axis range 
